"""
File: modifiedYellowbrick.py
Author: Jens Settelmeier
We removed here the missing value check of Yellowbricks RFECV wrapper.
Created: 18.10.23
"""
...
class RFECV(ModelVisualizer):
    ...
    def fit(self, X, y=None):
        ...
        """
        # X, y = check_X_y(X, y, "csr")  # This is the change to the original code
